export const Spanish = {
  ...
  pageDescriptions: {
    ...
    viewClientAccount: "viewClientAccount",
    createPost: "createPost",
    createProviderAccount: "create ProviderAccount",
    viewProviderAccount: "viewProviderAccount",
  ...
  messages: {
    ...
    signInAsProvider:
      "Inicie sesión en una cuenta de proveedor para poder publicar.",
    checkEmail: "¡Revise su correo electrónico para ver el enlace de reinicio!",
    checkConfirmEmail:
      "Si este correo electrónico aún no está registrado, recibirá un enlace de confirmación por correo electrónico.",
  ...
  footerData: {
    ...
    footNote: `<span class="float-left mr-1.5 w-5 h-5 bg-cover rounded-sm md:-mt-0.5 md:w-6 md:h-6"></span>
      <span class="text-text2 dark:text-text2-DM">Hecho por </span><a class="text-link2 dark:text-link2-DM dark:hover:text-link2Hov-DM hover:text-link2Hov" href="https://datagrove.com/"> Datagrove.</a><span class="text-text2 dark:text-text2-DM"> Todos los derechos reservados.</span>`,
  },

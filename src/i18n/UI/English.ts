export const English = {
  ...
  formLabels: {
    ...
    enterPostContent: 'Add a description of your resource here',
  ...
  footerData: {
    ...
    footNote: `
      ...
      <span class="text-ptext2 dark:text-ptext2-DM">Brought to you by</span><a class="text-link2 dark:text-link2-DM hover:text-link2Hov dark:hover:text-link2Hov-DM" href="https://datagrove.com/"> Datagrove.</a><span class="text-ptext2 dark:text-ptext2-DM"> All rights reserved.</span>
    `,
  },

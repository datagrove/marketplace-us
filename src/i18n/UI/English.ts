export const English = {
  ...
  pageDescriptions: {
    services: "services",
    signUp: "Provider your email and create a password to signup ",
    ...
    viewProviderAccount: "Manage your provider account ",
    clientViewProviderAccount: "client view provider account",
    page404: "404 - page not found",
    requestPasswordReset:
      "Forgot your password? Request a secure password reset",
    resetPassword: "Reset your password securely ",
    terms:
  ...
  messages: {
    ...
    checkConfirmEmail:
      "If this email is not already registered, you will receive an email confirmation link.",
  ...
  footerData: {
    links: [
      ...
      // },
      {
        ...
        // NEED TO ADD EMAIL
        links: [
          { text: "Contact Us", href: "mailto:support@.com" },
    ...
    footNote: `
      ...
      <span class="text-ptext2 dark:text-ptext2-DM">Made by</span><a class="text-link2 dark:text-link2-DM dark:hover:text-link2Hov-DM hover:text-link2Hov" href="https://datagrove.com/"> Datagrove.</a><span class="text-ptext2 dark:text-ptext2-DM"> All rights reserved.</span>
    `,
  },

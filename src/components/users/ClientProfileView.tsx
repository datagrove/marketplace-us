...
export const ClientProfileView: Component = () => {
    ...
    return (
        <div class="m-2 md:w-[44rem]">
            ...
            <div class=" md:drop-shadow-lg border border-border dark:border-border-DM md:mt-4 rounded-md md:h-fit md:px-4 md:pb-4 justify-center">
                    ...
                    <details class="bg-background1 dark:bg-black shadow rounded group md:hidden">
                        ...
                        <div class='p-4'>
                            ...
                            <label for="FirstName" class="text-text2 dark:text-text1-DM">{t('formLabels.firstName')}:
                                <p class="rounded w-full mb-4 px-1 focus:border-btn1 dark:focus:border-btn1-DM border-2 border-border dark:border-border-DM focus:outline-none">{client()?.first_name}</p>

                            </label>

                            <label for="LastName" class="text-text2 dark:text-text1-DM">{t('formLabels.lastName')}:
                                <p class="rounded w-full mb-4 px-1 focus:border-btn1 dark:focus:border-btn1-DM border-2 border-border dark:border-border-DM focus:outline-none">{client()?.last_name}</p>
                            </label>


                            <label for="ProviderName" class="text-text1 dark:text-text1-DM">{t('formLabels.providerName')}:
                                <p class="rounded w-full mb-4 px-1 focus:border-btn1 dark:focus:border-btn1-DM border-2 border-border dark:border-border-DM focus:outline-none">{client()?.display_name ? client()?.display_name : t('formLabels.noValue')}</p>
                            </label>
                            ...
                            <div class="w-full overflow-auto mb-4">
                                <label for="Email" class="text-text1 dark:text-text1-DM">{t('formLabels.email')}:
                                    ...
                                    <p class="rounded px-1 focus:border-btn1 dark:focus:border-btn1-DM border-2 border-border dark:border-border-DM focus:outline-none">{client()?.email}</p>
                                </label>
                            </div>

                            <label for="Phone" class="text-text1 dark:text-text1-DM">{t('formLabels.phone')}:
                                <p class="rounded w-full mb-4 px-1 focus:border-btn1 dark:focus:border-btn1-DM border-2 border-border dark:border-border-DM focus:outline-none">{client()?.client_phone}</p>
                            </label>

                            <label for="country" class="text-text1 dark:text-text1-DM">{t('formLabels.country')}:
                                <p class="rounded w-full px-1 focus:border-btn1 dark:focus:border-btn1-DM border-2 border-border dark:border-border-DM focus:outline-none">{client()?.country}</p>
                            </label>

                            <br />

                            <label for="MajorMunicipality" class="text-text1 dark:text-text1-DM">{t('formLabels.majorMunicipality')}:
                                <p class="rounded w-full px-1 focus:border-btn1 dark:focus:border-btn1-DM border-2 border-border dark:border-border-DM focus:outline-none">{client()?.major_municipality}</p>
                            </label>

                            <br />

                            <label for="MinorMunicipality" class="text-text1 dark:text-text1-DM">{t('formLabels.minorMunicipality')}:
                                <p class="rounded w-full px-1 focus:border-btn1 dark:focus:border-btn1-DM border-2 border-border dark:border-border-DM focus:outline-none">{client()?.minor_municipality}</p>
                            </label>

                            <br />

                            <label for="GoverningDistrict" class="text-text1 dark:text-text1-DM">{t('formLabels.governingDistrict')}:
                                <p class="rounded w-full px-1 focus:border-btn1 dark:focus:border-btn1-DM border-2 border-border dark:border-border-DM focus:outline-none">{client()?.governing_district}</p>
                            </label>
                        </div>
                    </details>
                ...
                <div class="hidden md:block">
                    <h2 class="text-xl text-text1 dark:text-text1-DM py-4 font-bold">
                        {client()?.display_name == '' ? client()?.first_name + ' ' + client()?.last_name : client()?.display_name}
                    </h2>
                    <div class="flex justify-center mb-3">
                        <Show when={typeof clientImage() !== "undefined"}>
                            <div class="relative w-48 h-48 overflow-hidden rounded-full md:h-48 md:w-48 lg:h-64 lg:w-64 object-contain justify-center border border-border dark:border-border-DM">

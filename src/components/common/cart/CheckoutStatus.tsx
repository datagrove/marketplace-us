...
const testPosts = {
    ...
    content: "this is a post, and I'm going to test it test test test can it be long so I cn truncate loooooong post here",
    user_id: "1",
    image_urls: null,
    seller_name: "Meagan Seller",
    seller_id: "6", 
    email: "me@me.com",
    price_id: "50",
    product_id: "4",
    ...
    subject: null,
    grade: null,//Array of grade names
    resourceTypes: null, //Array of resourceTypes names
    image_url: undefined,
    seller_img: undefined,
    price: 97, //Price of the post
    quantity: 1 //Quantity to add to cart from post
}
...
export const CheckoutStatus: Component = () => {
    ...
    onMount(async () => {
        // await CurrentCheckoutStatus(); // TODO: comment back in before committing
    });
    ...
    return (
        <div class="">
            <div
                class="flex-col items-center justify-center bg-btn1 text-white py-2 md:py-6" //TODO: add "hidden" before committing
                id="success"
            >
                <div class="flex justify-center">
                    <svg
                        ...
                        class="h-16 w-16 md:h-36 md:w-36 text-btn1"
                    >
                ...
                <p class="text-xl md:text-3xl font-bold text-center md:mt-2">{t("checkout.success")}</p>
                <p class="italic text-center md:my-2">{t("checkout.thankYou")}</p>
            </div>
            <div class="flex justify-center w-full">
                <div class="w-96 md:w-full md:max-w-[500px] mt-4">
                    <div class="text-lg">{t("checkout.orderID")}: {session()?.metadata?.orderId}</div>
                    <div class="flex justify-between mb-4 mt-2">
                        <p class="font-bold">{t("checkout.total")}</p>
                        
                        <p class="font-bold">${session()?.amount_total
                    ...
                    <div>
                        ...
                        {products().map((item) => (
                            <div class="flex justify-between my-2 md:my-4">
                            <a href={`/${lang}/posts/${ item.id }`}><p class="line-clamp-2 w-2/3">This is a really long resource name so that I can test the truncate styling - but no, make it even longer...LONGER!!!</p></a>
                    ...
                    <div class="flex flex-col md:flex-row items-center mt-8 md:mt-24 md:mb-8 justify-center">
                        <button 
                            class="border border-border1 dark:border-border1-DM w-64 my-1 rounded py-1 md:mx-4"
                        ...
                        <button 
                            class="bg-btn1 dark:bg-btn1-DM, rounded w-64 text-ptext2 dark:text-ptext2-DM my-1 py-1 md:mx-4"

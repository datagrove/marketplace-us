...
export const ProfileBtn = () => {
  ...
  return (
    <div class="">
      <button onclick={clickHandler} class="rounded-lg border border-border dark:border-white px-3 py-2 mr-4 md:mr-0 flex">
      ...
      <ul id="profileItems" class="hidden fixed z-50 right-2 bg-background1 dark:bg-black m-2 p-2 rounded-lg justify-start shadow-md dark:shadow-btn2">
        {renderWhenUser()}
        <div class="mt-2">
        <div>

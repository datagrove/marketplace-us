...
export const ProfileBtn = () => {
  ...
  function clickHandler() {
    ...
    if (listShow?.classList.contains("hidden")) {
      ...
      document.getElementById("profileBtnBackdrop")?.classList.remove("hidden");
    } else {
  ...
  return (
    <div class="">
      ...
      >
        <svg
          class="w-4 h-4 fill-icon1 dark:fill-icon1-DM mr-2"
          viewBox="0 0 32 32"
      ...
      <div
        ...
        class="hidden absolute h-full w-screen top-0 left-0"
        onClick={() => hideMenu()}
      >

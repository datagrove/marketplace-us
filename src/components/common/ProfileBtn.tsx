...
export const ProfileBtn = () => {
  ...
  return (
    <div class="border border-red-500">
      <button onclick={clickHandler} class="rounded-lg border border-border dark:border-white px-3 py-2 mx-5 flex">
      ...
      <ul id="profileItems" class="fixed z-50 right-2 bg-background1 dark:bg-black m-2 p-2 rounded-lg justify-start border border-green-500">
        {renderWhenUser()}
        <div class="mt-2">
          <AuthMode />
        </div>

...
export const ViewPurchaseCard: Component<Props> = (props) => {
    ...
    const [orderDate, setOrderDate] = createSignal<Date>();
    ...
    const getItemDates = async() => {
        ...
        // console.log("date test: ", typeof(orderDate()))
    }
                    ...
                    <div class="purchased-item-text-buttons border border-red-400 w-full ml-2">
                        ...
                        <div class="mt-4 mb-2">
                            <div class="flex mb-1">
                                ...
                                <p class="text-xs font-light">{t("menus.purchased")} </p>
                                <button onClick={ getItemDates }>date test</button>
                            </div>
                            ...
                            <div class="flex">
                                ...
                                <p class="text-xs font-light">{t("menus.updated")}</p>
                            </div>

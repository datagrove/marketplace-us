          ...
          <li class="w-[99%]">
            <a href={`/${lang}/posts/${post.id}`}>
              <div class="box-content flex flex-col justify-center items-center mb-2 w-full rounded-lg border border-opacity-25 shadow-md md:flex-row md:justify-start md:items-start md:h-48 dark:border-opacity-25 shadow-shadow-LM border-border1 dark:shadow-shadow-DM dark:border-border1-DM">
                <div class="flex justify-center items-center w-36 h-36 rounded-lg md:mr-2 md:w-48 md:h-48 bg-background1 dark:bg-background1-DM">
                  {post.image_url ? (
                    <img
                      src={post.image_url}
                      alt={
                  ...
                  <div class="w-full">
                    <div class="h-1/3">
                      ...
                      <div class="flex items-center">
                        ...
                        <p class="overflow-hidden text-xs font-light md:text-base text-ptext1 dark:text-ptext1-DM">
                          {post.seller_name}
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="hidden md:h-1/3 md:line-clamp-3">
                      <p
                        class="mr-1 text-xs text-ptext1 line-clamp-3 prose dark:text-ptext1-DM dark:prose-invert"
                        innerHTML={post.content}
                      ></p>
                    </div>

                    <div class="flex h-1/3 details-div">
                ...
                <div class="flex flex-col justify-between items-end pr-1 w-1/4 h-full">
                  ...
                  <div class="flex flex-col justify-end items-center w-full fileTypes-div">
                    <div class="flex justify-end items-center w-full">
                      ...
                      <p class="my-0.5 ml-1 text-xs">File Type 1</p>
                    </div>
                    ...
                    <div class="flex justify-end items-center w-full">
                      ...
                      <p class="my-0.5 ml-1 text-xs">Short</p>
                    </div>
                    ...
                    <div class="flex justify-end items-center w-full">
                      ...
                      <p class="my-0.5 ml-1 text-xs">Longer File Type</p>
                    </div>
                  </div>

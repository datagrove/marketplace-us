  ...
  return (
    <div class="search-form">
      <div class="form">
        ...
        <input type="text" name="query" id="search" class="border border-border1 dark:border-border1-DM rounded px-1 placeholder:text-ptext1 placeholder:opacity-[65%] placeholder:italic text-ptext1" placeholder={t('formLabels.search')} oninput={(e) => setSearchString(e.target.value)} />

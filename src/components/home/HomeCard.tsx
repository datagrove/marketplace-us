                            ...
                            <div class="border-2 border-border1 dark:border-border1-DM rounded mx-2 md:mx-1 p-1 w-40 mb-4 md:mb-0">
                                ...
                                <div id="homeCard-img" class="flex justify-center items-center h-36 w-34">
                                    { post.image_url ? (
                                        ...
                                        <svg width="200px" height="200px" viewBox="0 0 152.13541 152.13544" version="1.1" id="svg1" class="fill-icon1 dark:fill-icon1-DM"><defs id="defs1"/>
                                            <g id="layer1" transform="translate(-55.18229,-70.37966)"><g id="g1" transform="matrix(0.82682292,0,0,0.82682292,25.416666,40.614035)">

    ...
    return (
        <>
            <Modal
                ...
                buttonContent={
                    <div>
                        <svg viewBox="0 0 24 24" fill="none" class="w-4 h-4 mr-1 inline-block text-alert1 dark:text-alert1-DM">
                            <path
...
Reporting Id: ${props.user_id}`}
                        ...
                        <textarea
                            ...
                            rows="5"
                            placeholder={
                                t("messages.pleaseDescribe")
                            }
                            class="w-full block rounded-lg mt-2 mb-4 text-black placeholder:text-black placeholder:italic"
                        />

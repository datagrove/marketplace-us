...
export const EditPost: Component<Props> = (props: Props) => {
  ...
  const [subjectsArrayInNumbers, setSubjectsArrayInNumbers] = createSignal([])
  ...
  let subjectOriginalArrayInNumbers = []
  console.log(subjects.length)

  for (let i = 0; i < subjects.length; i++) {
    console.log(2222222222222222)
    console.log(props.post?.subject[i], "su")
    if (props.post?.subject[i] === subjects[i]?.name) {
      console.log(i)
      subjectOriginalArrayInNumbers.push(subjects[i].id!)
    }
  }
  console.log(subjectOriginalArrayInNumbers, "hol")

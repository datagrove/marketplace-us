...
alter table "public"."provider_post" add constraint "provider_post_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE not valid;

alter table "public"."provider_post" validate constraint "provider_post_user_id_fkey";

alter table "public"."providers" add constraint "providers_user_id_fkey" FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE not valid;

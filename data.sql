...
INSERT INTO "auth"."audit_log_entries" ("instance_id", "id", "payload", "created_at", "ip_address") VALUES
	('00000000-0000-0000-0000-000000000000', '11591eec-124c-4373-970b-00ed58b6a80e', '{"action":"login","actor_id":"a23376db-215d-49c4-9d9d-791c26579543","actor_username":"test4@test.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}', '2024-09-10 14:46:13.755939+00', ''),
	('00000000-0000-0000-0000-000000000000', 'e9616bdd-4e28-423e-8e4e-a87a2c115a70', '{"action":"logout","actor_id":"a23376db-215d-49c4-9d9d-791c26579543","actor_username":"test4@test.com","actor_via_sso":false,"log_type":"account"}', '2024-09-10 14:49:20.283935+00', ''),
	('00000000-0000-0000-0000-000000000000', '14691bc0-57d7-4560-adb8-b1cd949d93f9', '{"action":"login","actor_id":"a23376db-215d-49c4-9d9d-791c26579543","actor_username":"test4@test.com","actor_via_sso":false,"log_type":"account","traits":{"provider":"email"}}', '2024-09-10 14:50:09.180468+00', '');
...
INSERT INTO "auth"."users" ("instance_id", "id", "aud", "role", "email", "encrypted_password", "email_confirmed_at", "invited_at", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_new", "email_change", "email_change_sent_at", "last_sign_in_at", "raw_app_meta_data", "raw_user_meta_data", "is_super_admin", "created_at", "updated_at", "phone", "phone_confirmed_at", "phone_change", "phone_change_token", "phone_change_sent_at", "email_change_token_current", "email_change_confirm_status", "banned_until", "reauthentication_token", "reauthentication_sent_at", "is_sso_user", "deleted_at", "is_anonymous") VALUES
	...
	('00000000-0000-0000-0000-000000000000', 'a23376db-215d-49c4-9d9d-791c26579543', 'authenticated', 'authenticated', 'test4@test.com', '$2a$10$kb28zFsgV7Ff2KLr19LZ/.W3iEM.GssnZ5hPZf2I8YoQ1303cHOAm', '2024-03-19 18:42:48.187063+00', NULL, '', NULL, '', NULL, '', '', NULL, '2024-09-10 14:50:09.180685+00', '{"provider": "email", "providers": ["email"]}', '{"last_name": "test", "first_name": "test"}', NULL, '2024-03-19 18:42:48.175446+00', '2024-09-10 14:50:09.181256+00', NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL, false, NULL, false);
...
INSERT INTO "auth"."sessions" ("id", "user_id", "created_at", "updated_at", "factor_id", "aal", "not_after", "refreshed_at", "user_agent", "ip", "tag") VALUES
	...
	('f63cfe0a-cee3-40a9-aff6-86251b8fc4e0', 'a23376db-215d-49c4-9d9d-791c26579543', '2024-09-10 14:50:09.180718+00', '2024-09-10 14:50:09.180718+00', NULL, 'aal1', NULL, NULL, 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:130.0) Gecko/20100101 Firefox/130.0', '172.18.0.1', NULL);
...
INSERT INTO "auth"."mfa_amr_claims" ("session_id", "created_at", "updated_at", "authentication_method", "id") VALUES
	...
	('f63cfe0a-cee3-40a9-aff6-86251b8fc4e0', '2024-09-10 14:50:09.181348+00', '2024-09-10 14:50:09.181348+00', 'password', 'e021745c-543d-4533-960f-e8d09f91c846');
...
INSERT INTO "auth"."refresh_tokens" ("instance_id", "id", "token", "user_id", "revoked", "created_at", "updated_at", "parent", "session_id") VALUES
	('00000000-0000-0000-0000-000000000000', 6, 'k1N6Qi9HQ0qO9K7uU1hdlg', 'a23376db-215d-49c4-9d9d-791c26579543', false, '2024-09-10 14:50:09.180979+00', '2024-09-10 14:50:09.180979+00', NULL, 'f63cfe0a-cee3-40a9-aff6-86251b8fc4e0');
...
INSERT INTO "public"."seller_post" ("id", "created_at", "title", "content", "user_id", "image_urls", "stripe_price_id", "stripe_product_id", "product_subject", "post_grade", "resource_urls", "resource_types", "listing_status", "secular", "resource_links", "draft_status") VALUES
	(1, '2024-03-05 15:38:02.509065+00', 'Test Post 1', '<p>This post is for testing provider images in the cart and also longer post content so here is some more content to see if the cards properly cut off after three lines like we expect? Is this working? Test Test Test TESt testing Test</p>', '84a298b6-9caf-4305-9bfe-3ea325df9188', NULL, 'price_1OtG6cBRZLMDvS4Ri22IpzGq', 'prod_PihVI0liGFkala', '{1,2,3}', '{1,2,3}', NULL, '{1,2,3}', true, true, NULL, false),
	(5, '2024-03-05 21:53:47.560102+00', 'Geography course', '<p>test</p>', '84a298b6-9caf-4305-9bfe-3ea325df9188', NULL, 'price_1OtFqrBRZLMDvS4RK5Ajf7na', 'prod_PihF0aDvvT4PeU', '{2,6,7}', '{1}', NULL, '{4}', true, false, NULL, false),
	(3, '2024-03-05 21:52:06.919336+00', 'Math course', '<p>test</p>', '84a298b6-9caf-4305-9bfe-3ea325df9188', NULL, 'price_1OtFmkBRZLMDvS4RJ8TNXGrH', 'prod_PihB8lq2HWY15J', '{3}', '{1}', NULL, '{5}', true, true, NULL, false),
	(2, '2024-03-05 15:40:05.243892+00', 'Test Post 2', '<p>test</p>', '84a298b6-9caf-4305-9bfe-3ea325df9188', NULL, 'price_1OtFjpBRZLMDvS4RPoOg78AS', 'prod_Pih8Qrjfpr0Zmo', '{1}', '{1}', NULL, '{3,5,9,12}', true, false, NULL, false),
	(6, '2024-03-05 21:54:44.695358+00', 'programming course ', '<p>test learn programming</p>', 'a23376db-215d-49c4-9d9d-791c26579543', NULL, 'price_1OtFmFBRZLMDvS4RsYXD3Q3C', 'prod_PihAqPK24WxqZp', '{3,4,5}', '{1,4,6}', NULL, '{1,2,3}', true, false, NULL, false),
	(7, '2024-03-27 14:25:37.137856+00', 'Test', '<p>This post is for testing provider images in the cart and also longer post content so here is some more content to see if the cards properly cut off after three lines like we expect? Is this working? Test Test Test TESt testing Test</p>', 'b78eab21-c34e-41ef-9a72-64ee49f4cbc0', NULL, 'price_1OyxQ5BRZLMDvS4RJ1oWeAIj', 'prod_PoabbRuN1tqxj0', '{7}', '{1}', NULL, '{1,2,3}', true, false, NULL, false),
	(10, '2024-03-27 15:49:08.243995+00', 'Testing testing', '<p>test</p>', 'b00f3d62-4eb1-40ba-b73e-e3dc78eff08a', NULL, 'price_1OyyiuBRZLMDvS4Rpb0hhUK3', 'prod_PobwysGlI4L0OK', '{5}', '{1}', NULL, '{7,9,12}', true, true, NULL, false),
	(11, '2024-03-27 15:50:36.102267+00', 'New Test', '<p>Test</p>', 'b00f3d62-4eb1-40ba-b73e-e3dc78eff08a', NULL, 'price_1OyykKBRZLMDvS4RC4SRSDLb', 'prod_PobyNSYyDLZArR', '{6}', '{1}', NULL, '{1,2,3}', true, true, NULL, false),
	(12, '2024-03-27 15:53:32.292584+00', 'Another test', '<p>test</p>', 'b00f3d62-4eb1-40ba-b73e-e3dc78eff08a', NULL, 'price_1OyynABRZLMDvS4RMi5Z83UK', 'prod_Poc1Kl6ObNXQ89', '{4}', '{1}', NULL, '{1,2,3}', true, true, NULL, false),
	(13, '2024-05-17 16:10:12.692569+00', 'Free Post Test', '<p>Test free post</p>', 'a23376db-215d-49c4-9d9d-791c26579543', NULL, 'price_1PMZvBBRZLMDvS4RcPyxuTRL', 'prod_QCzvzVmGr9GP84', '{3}', '{3}', NULL, '{10,11,12}', true, true, NULL, false);
...
INSERT INTO "public"."sellers" ("created_at", "seller_name", "user_id", "image_url", "seller_id", "language_spoken", "stripe_connected_account_id", "seller_about", "contribution") VALUES
	...
	('2024-03-19 19:37:25.638743+00', 'test test', 'a23376db-215d-49c4-9d9d-791c26579543', NULL, 4, NULL, 'acct_1Ow8TSB0tPFjRwUY', NULL, 0),
